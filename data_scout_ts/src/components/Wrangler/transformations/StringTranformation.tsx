...
interface StringTransformationState { }

export class StringTransformationButton extends React.PureComponent<TranformationProps, StringTransformationState> {
    public state: StringTransformationState = {};
